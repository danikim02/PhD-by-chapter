...
#hrlist_fi1sd_m = lapply(mylist, run_age_at_risk_cox_model, frailty = "fi_transformed", sex = "M")
#hrlist_fi1sd_f = lapply(mylist, run_age_at_risk_cox_model, frailty = "fi_transformed", sex = "F")
```
...
hrlist = list(hrlist_fi5_t, hrlist_ficat_t, hrlist_fi1sd_t)

names(hrlist) = c("HRs FI quintile and outcomes overall", "HRs FI level and outcomes overall", "HRs FI 1SD and outcomes overall")
